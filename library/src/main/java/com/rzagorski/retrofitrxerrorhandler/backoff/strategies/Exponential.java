...
public class Exponential extends BaseBackoffStrategy {
    ...
    public static class Builder implements AddReaction<Builder>, AddDelay, Optional {
        ...
        @Override
        public BaseBackoffStrategy.Optional setOnRetryAction(Action2<Throwable, Integer> onRetryAction) {
            baseBuilder.setOnRetryAction(onRetryAction);
            return this;
        }

        @Override
        public BaseBackoffStrategy.Optional setRetryFunction(Func1<Throwable, Boolean> retryIf) {
